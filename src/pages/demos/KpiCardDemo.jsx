...
import {
  Users, CreditCard, Activity, AlertCircle, TrendingUp,
  Shield, Zap, Clock,
    ...
    >
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <KpiCard label="Active Now" value="573" change="+19%" up icon={<Activity style={{ width: 16, height: 16 }} />} />
          <KpiCard label="Incidents" value="12" change="-3" up={false} icon={<AlertCircle style={{ width: 16, height: 16 }} />} />
        </div>
      </PlaygroundSection>
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <KpiCard label="API Calls" value="12,847" change="+5.2%" up icon={<Zap style={{ width: 16, height: 16 }} />}>
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <KpiCard label="Default" value="1,234" variant="default" change="+8%" up icon={<TrendingUp style={{ width: 16, height: 16 }} />} />
          <KpiCard label="Bordered" value="5,678" variant="bordered" change="+12%" up icon={<TrendingUp style={{ width: 16, height: 16 }} />} />
          <KpiCard label="Filled" value="9,012" variant="filled" change="-2%" up={false} icon={<TrendingUp style={{ width: 16, height: 16 }} />} />
        </div>
      </PlaygroundSection>
      ...
      >
        <div className="space-y-4">
          <div>
            <p className="text-[11px] font-[500] text-[var(--invin-text-faint)] uppercase mb-2">Small</p>
            <KpiCard label="Users Online" value="42" size="sm" icon={<Users style={{ width: 14, height: 14 }} />} />
          </div>
          <div>
            <p className="text-[11px] font-[500] text-[var(--invin-text-faint)] uppercase mb-2">Medium (default)</p>
            <KpiCard label="Users Online" value="42" size="md" change="+3" up icon={<Users style={{ width: 16, height: 16 }} />} />
          </div>
          <div>
            <p className="text-[11px] font-[500] text-[var(--invin-text-faint)] uppercase mb-2">Large</p>
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <KpiCard label="OPEN INCIDENTS" value="7" change="-2 from yesterday" up={false} icon={<AlertCircle style={{ width: 16, height: 16 }} />} />
          ...
          <KpiCard label="COMPLIANCE" value="94%" icon={<TrendingUp style={{ width: 16, height: 16 }} />}>
