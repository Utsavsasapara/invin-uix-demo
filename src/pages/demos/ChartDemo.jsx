        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-text-dim">
              The Chart component provides a themed wrapper for Recharts. To use it, install <code className="text-xs bg-bg-elevated px-1 py-0.5 rounded">recharts</code> in your project and use the ChartContainer, ChartTooltip, and ChartTooltipContent components for consistent styling.
            </p>
            <div className="mt-4 h-32 rounded-md bg-bg-elevated flex items-center justify-center text-sm text-text-dim">
